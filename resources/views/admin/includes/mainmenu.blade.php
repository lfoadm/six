        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{ asset('panel/dist/img/user1-128x128.jpg') }}" alt="User Avatar"
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="/paneladmin" class="brand-link">
        <img src="{{ asset('panel/dist/img/logo.png') }}" alt="Six Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Six</span>
    </a>
    <div class="sidebar">
